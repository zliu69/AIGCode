...
def create_model_config_from_pretrained_config(config: OLMoXMoEConfig):
    """
    Utility function
    """
...
class OLMoXMoEForCausalLM(PreTrainedModel):
    """
    Extremely barebones HF model wrapper.
    """

    config_class = OLMoXMoEConfig
    base_model_prefix = "model"
    _no_split_modules = ["OLMoXMoEBlock"]

    def __init__(self, config: OLMoXMoEConfig, model: Optional[OLMo] = None, init_params: bool = False):
    ...
    def forward(
        ...
        if output_attentions:
            raise ValueError("output_attentions is not yet supported in OLMoXMoE")
...
AutoModelForCausalLM.register(OLMoXMoEConfig, OLMoXMoEForCausalLM)
