...
def write_model(checkpoint_dir: str, ignore_aigcode_compatibility: bool = False):
...
def convert_checkpoint(checkpoint_dir: str, ignore_aigcode_compatibility: bool = False):
    write_config(checkpoint_dir)
    write_model(checkpoint_dir, ignore_aigcode_compatibility=ignore_aigcode_compatibility)
...
def main():
    ...
    convert_checkpoint(args.checkpoint_dir, args.ignore_aigcode_compatibility)
