...
remote_sharded_checkpoint=$(python -c "from aigcode.util import find_latest_checkpoint; print(find_latest_checkpoint('s3://ai2-llm/checkpoints/AIGCcode-large/mitchish70-002'))")
