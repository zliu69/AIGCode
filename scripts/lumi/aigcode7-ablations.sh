#!/bin/bash
#SBATCH --job-name=aigcode7-ablation
...
export AIGCODE_CONTAINER=llm-lumi-torch21_latest.sif
...
export DATA_PATH=$FLASH_DIR/preprocessed/aigcode-mix
...
srun \
  ...
  scripts/run_with_environment.sh \
    ...
    python scripts/train.py configs/aigcode7-ablation.yaml ${@} \
