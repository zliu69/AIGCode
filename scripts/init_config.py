...
from aigcode import TrainConfig
from aigcode.exceptions import AIGCcodeCliError
from aigcode.util import clean_opt, prepare_cli_environment
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise AIGCcodeCliError(f"Usage: {sys.argv[0]} [SAVE_PATH] [OPTIONS]")
