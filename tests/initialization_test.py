...
from aigcode.config import InitFnType, ModelConfig
from aigcode.model import BufferCache, AIGCcode, AIGCcodeBlock, AIGCcodeLlamaBlock, AIGCcodeSequentialBlock
...
def test_aigcode_block_init_normal(seed: int):
    seed_all(seed)
    ...
    for layer_id in [0, 4]:
        block = AIGCcodeBlock(layer_id=layer_id, config=base_config, cache=cache)
    ...
    block = AIGCcodeBlock(layer_id=0, config=base_config, cache=cache)
    block.reset_parameters()
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_block_init_mitchell(seed: int):
    seed_all(seed)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_block_init_full_megatron(seed: int):
    seed_all(seed)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_sequential_block_init_normal(seed: int):
    seed_all(seed)
    ...
    for layer_id in [0, 4]:
        block = AIGCcodeSequentialBlock(layer_id=layer_id, config=base_config, cache=cache)
        block.reset_parameters()
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_sequential_block_init_mitchell(seed: int):
    seed_all(seed)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_sequential_block_init_full_megatron(seed: int):
    seed_all(seed)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_llama_block_init_normal(seed: int):
    seed_all(seed)
    ...
    for layer_id in [0, 4]:
        block = AIGCcodeLlamaBlock(layer_id=layer_id, config=base_config, cache=cache)
        block.reset_parameters()
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_llama_block_init_mitchell(seed: int):
    seed_all(seed)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_llama_block_init_full_megatron(seed: int):
    seed_all(seed)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_init_normal(seed: int):
    d_model = 1024
    n_heads = 2
    n_layers = 2
    ...
    module = AIGCcode(config=base_config, init_params=True)
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_init_mitchell(seed: int):
    d_model = 1024
    n_heads = 2
    n_layers = 2
...
@pytest.mark.parametrize("seed", list(torch.randint(1, 10000, (3,))))
def test_aigcode_init_full_megatron(seed: int):
    d_model = 1024
    n_heads = 2
    n_layers = 2
