...
class ModelConfig(BaseConfig):
    ...
    rope_ext_ratio: Optional[int] = 1
    latent_attention: Optional[bool] = False
    latent_attention_dim: Optional[int] = 512

    gate_softmax_temperature: Optional[float] = 1.0
    exp_dim_ratio: Optional[int] = 2
    eval_max_sequence_length: Optional[int] = None
    sft_ans_mask: Optional[bool] = False
    gshard: Optional[bool] = False
    batch_size: Optional[int] = 4
    gate_level: Optional[str] = "token"
    gate_sample_ratio: Optional[int] = 1
    moe_gate_input_type: Optional[str] = "concat"
    deepnorm: Optional[bool] = False
    encoder_decoder: Optional[bool] = False
    use_mobile_llm: Optional[bool] = False
    mobile_llm_repeat_num: Optional[int] = 1
    use_moe: Optional[bool] = False
    moe_version: Optional[int] = 1
    use_xmoe: Optional[bool] = False
    moe_logging: Optional[bool] = False
    use_ple: Optional[bool] = False
    ple_layer_num: Optional[int] = 0
    ple_layernorm: Optional[bool] = False
    moe_freq: Optional[int] = 0
    moe_act_ckpt_ratio: Optional[int] = 1
    moe_freq_pos: Optional[int] = 0
    layer_share: Optional[bool] = False
    layer_share_mlp_version: Optional[int] = 1
    share_layer_groups: Optional[int] = 1
    share_moe_groups: Optional[int] = 1
    intermediate_size: Optional[int] = 0
    moe_top1_expert: Optional[bool] = False
    moe_topn_expert: Optional[int] = 1
    moe_expert_count: Optional[int] = 8
    moe_expert_count_mluti_level: Optional[List[int]] = None
    moe_share_expert_count: Optional[int] = 0
    moe_gate_loss_weight: Optional[float] = 0.0
    moe_gate_loss_combine_method: Optional[str] = None
    moe_gating_use_fp32: Optional[bool] = False
    moe_gating_use_fp32: Optional[bool] = False
    moe_second_expert_policy: Optional[str] = "sampling"
    moe_normalize_gate_prob_before_dropping: Optional[bool] = False
    moe_eval_capacity_token_fraction: Optional[float] = 0.25
    moe_batch_prioritized_routing: Optional[bool] = False
    moe_auxiliary_loss: Optional[bool] = False
    moe_auxiliary_loss_weight: Optional[float] = 0.0
    moe_gate_no_grad: Optional[bool] = False
    layer_std_check: Optional[bool] = False
...
class DataConfig(BaseConfig):
    ...
    data_dir: Optional[List[Dict[str, float]]] = None
...
class TrainConfig(BaseConfig):
    ...
    gpu_type: Optional[str] = "cuda"
    """
    Choose gpu type: 'cuda' or 'ascend'.
    """
    ...
    moe_expert_lr_scale: Optional[float] = 1.0
    """
    A positive factor used to scale the Expert ffn params lr.
    """

    moe_grad_norm_scale: Optional[float] = 1.0
    """
    A positive factor used to scale the Expert ffn params max grad norm (or ratio).
    """

    moe_gate_lr_scale: Optional[float] = 1.0
    """
    A positive factor used to scale the Expert ffn params lr.
    """

    moe_gate_grad_norm_scale: Optional[float] = 1.0
    """
    A positive factor used to scale the Expert ffn params max grad norm (or ratio).
    """

    moe_gate_weight_decay: Optional[float] = 0.1
    """
    A positive factor used to scale the Expert ffn params max grad norm (or ratio).
    """
    ...
    moe_auxiliary_loss: Optional[bool] = False
    moe_auxiliary_loss_weight: Optional[float] = 0.0
    moe_params_isolation: Optional[bool] = True
    moe_logging: Optional[bool] = False
    train_eval: Optional[bool] = False
