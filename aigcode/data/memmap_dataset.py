...
from aigcode.exceptions import AIGCodeEnvironmentError
...
class MemMapDataset(Dataset[Dict[str, Any]]):
    ...
    def offsets(self) -> List[Tuple[int, int]]:
        ...
        try:
            _get_s3_client("r2")
        except AIGCodeEnvironmentError:
        ...
        if self._mmap_offsets is None:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                for i, path in enumerate(self._memmap_paths):
                    ...
                    if self._label_mask_paths is not None and i<len(self._label_mask_paths):
            ...
            for path in self._memmap_paths:
                ...
                if mask_path_to_length and path in path_to_mask_path.keys():
    ...
    def __getitem__(self, index: int) -> Dict[str, Any]:
        ...
        if self._label_mask_paths is not None and memmap_index < len(self._label_mask_paths):
            ...
            out["label_mask"] = torch.ones_like(input_ids, dtype=torch.bool)
